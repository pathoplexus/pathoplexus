...
export const newsItems: NewsItem[] = [
    {
        ...
        date: '19 May 2026',
        excerpt:
            'In response to the current Ebola outbreak in the Democratic Republic of Congo (DRC) and Uganda, Pathoplexus has added support for Bundibugyo virus (BDBV), an orthoebolavirus known to cause severe Ebola disease in humans. This addition is in response to reports from the health authorities…',
    },
    {
