...
export const tools: Tool[] = [
    {
        name: 'GenSpectrum',
        description:
            'GenSpectrum is an interactive dashboard that visualizes the spatio-temporal distribution of sequences and in-depth analysis of variants and mutations.',
    ...
    },
    {
        ...
        description:
            'A simple dashboard visualizing the number of sequences over time, data use terms and the geographic distribution',
    ...
    },
    {
        name: 'VIRUS-MVP',
        description:
            'VIRUS-MVP is a modular, open-source platform for visualizing, annotating, and interpreting viral genomic variation across diverse sample types and pathogens.',
