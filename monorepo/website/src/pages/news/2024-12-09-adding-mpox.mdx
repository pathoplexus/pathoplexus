...
title: "Addition of mpox"
---

<div>
    <a href="/news">News</a> > <b>Addition of mpox</b>
</div>
...
### Milestones:
- Another big first for Pathoplexus: our first direct sequence submission! The [Grubaugh Lab](https://grubaughlab.com/) at Yale School of Public Health uploaded [630 full-genome West Nile Virus sequences in November](https://pathoplexus.org/west-nile/search?visibility_authorAffiliations=true&authorAffiliations=Grubaugh+Lab%2C+Yale+University%2C+CT%2C+USA). These sequences were Open, and so have passed to INSDC-member databases and are [visible there](https://www.ncbi.nlm.nih.gov/bioproject/PRJEB80643/)!
- And one last first - we’ve had our first "curation" to correct erroneous data! Anyone can [report an issue](https://github.com/pathoplexus/curation_reports/issues) where data may be incorrect, and our [team of curators](https://pathoplexus.org/about/development-team#curators) will [assess the reported error](https://pathoplexus.org/docs/how-to/curator-sop) and, if the data has come from INSDC, make a correction directly! (All changes are tracked through versioning).
Big thanks to Peter van Heusden for [spotting the error](https://github.com/pathoplexus/curation_reports/issues/2), and Emily Smith and Michael Martin for putting our [first curation into action](https://pathoplexus.org/ebola-sudan/search?accession=PP_00000UB)!
...
![screenshot highlighting how filtering works with date ranges](/gifs/news/2024-12-09-adding-mpox/date-range.jpg)
...
![screenshot showing error, warning, and no issues categories on review page](/gifs/news/2024-12-09-adding-mpox/review-filter.jpg)

### Pathoplexus Association Update:
- In a [recent General Assembly](https://pathoplexus.org/about/governance/minutes/2024-11-25_PathoplexusGAmeeting.pdf), we adapted our Statutes to include the role of Treasurer, to aid us in opening a bank account and for helping to monitor (future!) finances
