...
Our belief is that core scholarly infrastructure should be open and should welcome feedback. We are very keen to engage with the community: you can get involved on our **Discussion board \[here]** and discuss anything related to sequence submission, retrieval, and much more. You can also connect with us on [Mastodon](https://mstdn.science/@pathoplexus), [Bluesky](https://bsky.app/profile/pathoplexus.org), or [Twitter](https://x.com/pathoplexus) .
...
Connect with us: [Mastodon](https://mstdn.science/@pathoplexus), [Bluesky](https://bsky.app/profile/pathoplexus.org), [Twitter](https://x.com/pathoplexus), Discussion Board, [email](mailto:hello@pathoplexus.org)
