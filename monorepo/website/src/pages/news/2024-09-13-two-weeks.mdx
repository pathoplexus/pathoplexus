...
- See a list of the most [recent resolutions passed by the Pathoplexus Executive Board](/about/governance/minutes/2024-09-12_EB_Resolutions.pdf)

### Scientific Advisory Board:
- We’re incredibly pleased to welcome Pardis Sabeti from the Broad Institute, Harvard University, and HHMI to the [Scientific Advisory Board](/about/sab)!

### Software updates:
- Our code is open-source and on [GitHub](https://github.com/pathoplexus). Thank you to everyone from the community who have made suggestions for improvements to [Loculus](https://github.com/loculus-project/loculus/issues) (the software behind Pathoplexus). Since launch, we’ve added a few features and fixed some bugs. All enhancements and bug-fixes are documented on GitHub. Severe incidents with high impact will also be reported on this news page.
