...
- The raw reads data will be available for download on Pathoplexus as soon as you release your submission.
...
The requirements are that your reads are in [gzip compressed](/docs/how-to/upload-raw-reads#compressing-your-files) `fastq` format, that paired-end reads are two separate files (interleaved files are not supported), that [human reads have been removed](/docs/how-to/upload-raw-reads#dehosting-host-read-removal), and that you provide some [raw reads-specific metadata](/docs/how-to/upload-raw-reads#raw-reads-specific-metadata).
