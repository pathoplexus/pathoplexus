...
- We are excited to have hit 100 users! (Necessary to upload data but not to view data)
...
- Pathoplexus is now registered as a tax-exempt organization in Switzerland - any donations made by Swiss residents are tax-deductible
...
### Upcoming events:
- IPSN (Anderson, Emma G, Peter)
  - Emma Hodcroft at [VGEB](https://escv2024.org/) on Pathoplexus (18-21 Sept, Frankfurt)
  - Chaoran Chen at [VGEB] (https://asm.org/events/asm-ngs/home) on Loculus (13-16 Oct, Washington DC)
