...
Users can specify the time period for which data is "Restricted-Use Data", up to a maximum of one year, and also manually release data from Restricted Use before the time period expires. When the Restricted Use period has ended, Restricted-Use Data becomes Open Data within Pathoplexus, and is submitted on user's behalf to the INSDC.
