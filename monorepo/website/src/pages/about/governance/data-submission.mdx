...
Generally, Pathoplexus does not permit the permanent removal of sequences, since this is non-transparent and causes confusion when a record cannot be traced. Thus, this can only be done through the intervention of a Pathoplexus administrator and under very specific circumstances.
