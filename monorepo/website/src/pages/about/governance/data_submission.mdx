...
You can find a list of our current Curators [here](/about/development_team#curators). 
This is linked to the process of [Revision](#7-revision).

Curators follow a well-described procedure, which can be viewed [here](../../docs/how-to/curator_sop), in deciding when to flag errors and when to suggest, and accept, revisions. 
...
In either case, an error is only considered likely if **two** curators independently agree that the evidence presented in our ['Curation reports'](https://github.com/pathoplexus/curation_reports) Github respository strongly supports the error. 
...
You can find out how to submit a Revision [here](/docs/how-to/revise_submissions).
...
More detail about how data can be edited and curated is available [here](../../docs/how-to/curator_sop). 
See also the section on [Curation](#6-curation), above.

</div>

Anyone can flag a suspected error to the attention of Curators, by detailing the nature of the possible error and the supporting evidence [as a Github issue in 'Curation Reports'](http://localhost:3000/docs/how-to/report_sequence_issues) (preferred) or in an email to [submissions@pathoplexus.org](mailto:submissions@pathoplexus.org). 
...
You can read how to revoke a sequence [here](/docs/how-to/revoke_sequences).
