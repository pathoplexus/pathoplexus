...
The term of office is 2 years and runs between ordinary General Assemblies. For elections held between ordinary General Assemblies, the term of office is calculated from the previous ordinary General Assembly. Should their expertise and advice continue to be a benefit to the Executive Board and General Assembly, the Executive Board may renew their service for any number of terms.
...
The Scientific Advisory Board should be guided in their advice as pertinent to the tenets in the Pathoplexus Values, with the aim to preserve and further the mission and values.
