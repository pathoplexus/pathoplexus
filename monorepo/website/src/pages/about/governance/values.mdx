...
2. To process, manage, and store data uploaded by Submitters and to make them available to Users via the website and a web API under specific Data Use Terms (link);
