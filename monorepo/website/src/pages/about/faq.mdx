...
Pathoplexus is a transparent, non-profit association with [members](/about/members) from 10 countries in 5 continents, and an [Executive Board](/about/exec_board) from around the globe.
...
Pathoplexus is proud work closely with [PHA4GE](https://pha4ge.org/), an international group working to establish better standards for public health and bioinformatics. 
...
Aside from this, Pathoplexus has been created by and is powered by thousands of hours of donated time and effort by members of the bioinformatics community (see our [members](../../about/members) and [development team](../../about/development_team)).
</details>
...
You can upload data to any of our supported pathogens by first [creating an account](/docs/how-to/create_account) and then [submitting your sequences](/docs/how-to/upload_sequences) on the website or via the API (useful for computational pipelines). 
...
You can easily tell if a sequence originated from INSDC if the 'Submitter' is `insdc_ingest_user`.
...
You can easily tell if Open data was submitted to us directly by seeing if the 'Submitter' is anyone other than `insdc_ingest_user`.
</details>
...
Please send an email to [funding\@pathoplexus.com](mailto:funding@pathoplexus.org), and we'll be in touch!
</details>
