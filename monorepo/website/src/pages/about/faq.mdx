...
Pathoplexus is truly a community-driven project, and its initial development was largely powered by donated time and computational resources. We have received the following monetary assistance: a financial award from Kanro; legal advice for our GDPR statement via PHA4GE; donation of compute time via Prof Artem Babian, University of Toronto; donation of compute credits from Amazon Web Services. 
...
The Loculus software that powers Pathoplexus has been supported by: grants from the swissuniversities Open Research Data grant and donation of contract developer time from Prof Tanja Stadler. You can find out more about how to donate to Pathoplexus on our [Funding page](/about/funding).
