...
If you've chosen for your data to be open straight away, it will be submitted to the European Nucleotide Archive (ENA). It can take up to a week for data to appear on ENA.
...
Once we secure further funding, some of our top priorities are:
