...
The Pathoplexus Executive Board is defined and guided by the [Pathoplexus Statutes](/about/governance/pathoplexus-statutes) and [Executive Board Guidelines](/about/governance/eb-guidelines). All Executive Board members serve in an individual capacity; affiliations are shown simply to show their expertise.
