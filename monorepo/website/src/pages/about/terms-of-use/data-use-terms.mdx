...
and [what data is sensitive](/about/terms-of-use/terms_of_service#2-data-quality-data-rights-and-liability)) 
...
1. One or more Submitters must be included as an author on the manuscript (as agreed with the Submitting Group) ("Authorship") 
**or**
...
Please see our how-to [here](/docs/how-to/generate_seqset) for how to create a SeqSet.
