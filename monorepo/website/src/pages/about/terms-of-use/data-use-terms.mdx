...
Restricted-Use Data is displayed in Pathoplexus with a clear indication that its use is restricted, until the expiration of the Restricted-Use period of up to one year. After the Restricted Use period ends, Restricted-Use Data becomes Open Data. 
