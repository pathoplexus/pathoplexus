...
- Create a SeqSet — this is the best way to permanently and precisely cite the data you used. ([How to create a SeqSet](https://pathoplexus.org/docs/how-to/generate-seqset))
- If using the data in a manuscript, generate a DOI for the SeqSet and be sure to cite it as a reference (like a paper) — this allows us to link use back to each sequence.
...
- Provide a list of accession numbers used, or create a [SeqSet](https://pathoplexus.org/docs/how-to/generate-seqset) (recommended if using more than 5 sequences). SeqSets can be updated with versioning, including via the API.
...
Create a SeqSet, generate a DOI, and cite the DOI **as a reference**.
