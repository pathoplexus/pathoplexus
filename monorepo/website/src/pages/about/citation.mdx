...
- Provide a list of accession numbers used, or create a [SeqSet](https://pathoplexus.org/docs/how-to/generate-seqset) (recommended if using more than 5 sequences). Seqsets can be updated with versioning, including by API.
