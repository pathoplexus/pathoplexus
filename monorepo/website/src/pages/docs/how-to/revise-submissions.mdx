...
**You must use the _original metadata_ when doing a revision!** (In other words, the original files you submitted to Pathoplexus.) Currently you will need to have this file locally - we aim to introduce a way to download this from Pathoplexus soon. If you do not have these files, please _contact us_ to help you do the revision.
...
You should also include the `submissionId` column, which will match the sequence names in your FASTA file.
