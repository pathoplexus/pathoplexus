...
**Important:** The `accession` column should contain the accession **without** the version number. For example, use `PPX_0049AAG` rather than `PPX_0049AAG.1`. (See [Accessions](/docs/concepts/accession) for more information on accession format.)
