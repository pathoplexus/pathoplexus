...
- Raw reads files in `fastq.gz` format (optional). Details [here](/docs/how-to/upload-raw-reads).
...
The metadata and sequence data files can be compressed: accepted formats here are .zst, .gz, .zip and .xz.
