...
To ensure your raw reads are linked to your consensus sequence in the INSDC, both must be associated with the same biosample and bioproject at the time of submission. We suggest you submit consensus sequences first to ensure metadata consistency.
