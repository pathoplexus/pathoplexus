...
<br></br>
_Detailed API instructions for submitting sequences will come soon, but you can read our [authentication token how-to](/docs/how-to/authentication-api) and [Swagger API documentation](/api_documentation) if you're an experienced user._
