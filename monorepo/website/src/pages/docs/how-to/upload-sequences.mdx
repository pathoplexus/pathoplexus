...
<InfoBox>
    To use the <a href="https://demo.pathoplexus.org" class="!text-black">demo instance</a> instead of the main instance, please replace `backend.pathoplexus.org` with `backend-demo.pathoplexus.org`.
</InfoBox>
