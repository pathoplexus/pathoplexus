...
4. Optional: upload the raw reads that were used to derive the consensus sequence. This is done by clicking the 'Upload folder: Raw reads' box on the submission page, which will ask  you to select a folder containing the raw reads files.
