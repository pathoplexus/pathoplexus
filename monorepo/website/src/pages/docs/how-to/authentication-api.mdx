...
<InfoBox>
    To use the <a href="https://demo.pathoplexus.org" class="!text-black">demo instance</a> instead of the main instance, please replace `authentication.pathoplexus.org` with `authentication-demo.pathoplexus.org`.
</InfoBox>
