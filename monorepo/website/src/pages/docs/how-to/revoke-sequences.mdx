...
You can read more about the circumstances under which sequences could/should be revoked in the [Revocation](/about/governance/data-submission#81-revocation) section of the Data Submission and Processing document.
...
Deletion is generally _not_ permitted by Pathoplexus, since this is non-transparent and causes confusion when a record cannot be traced.
...
in the [Deletion](/about/governance/data-submission#82-deletion) section of the Data Submission and Processing document.
