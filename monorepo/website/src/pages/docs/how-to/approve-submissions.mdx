...
You can only approve and release sequences that have yellow (warnings) or green checkmarks (neither warnings nor errors) - you cannot approve and release sequences with errors.
