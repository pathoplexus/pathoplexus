...
Once you've uploaded sequences via the website or [API](/api_documentation), you will have to approve them before they are fully submitted.
...
If see something you'd like to change, or want to try and resolve a warning, you can [edit the sequence](edit_submissions).
...
If you leave any sequences unreleased, you can view, [edit](/docs/how-to/edit_submissions), and approve/release (if they have no errors) them at a later time.
...
_Instructions coming soon. See the [Swagger API documentation](/api_documentation)_
