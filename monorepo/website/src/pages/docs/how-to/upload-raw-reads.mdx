...
When [submitting to Pathoplexus](/docs/how-to/upload-sequences), you can include the raw reads that were used to generate your consensus sequences. To do this, you will need to upload the raw reads files and link them to their respective sequences via the `files.rawReads` field in your metadata file.
