...
3. Fill in the required information about your group. Please check the ['Group naming recommendations'](#group-naming-recommendations) section below.
...
To help others recognize your group and avoid duplication, please follow these best practices when choosing a name:

- Include your lab name, institution, and country.
- Avoid vague names. Prefer full names over acronyms unless they are widely recognized.
- If your lab is part of a consortium or department, consider including that too.

These naming conventions ensure your group is identifiable, searchable, and distinguishable from others on the platform.
