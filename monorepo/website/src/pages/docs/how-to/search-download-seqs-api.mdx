...
For full instructions on how to use our API, you should read our [Swagger API documentation](/api_documentation).
...
As noted above, for full details on the range of requests that can be processed via the API, you should see the [Swagger API documentation](/api_documentation).
...
As mentioned previously, here we use `GET` requests, but for more intense and comprehensive use, you may want to learn more about `GET` and `POST` requests, as well as the [Swagger API](/api_documentation).
...
For full details, you should review the [Swagger API documentation](/api_documentation). However, some basic examples are given below:
