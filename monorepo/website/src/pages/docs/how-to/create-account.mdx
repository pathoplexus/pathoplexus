...
To begin creating a new account, click 'Login' in the top-right on the website. You will be prompted with a contextual menu with the options at the bottom to <em>login with ORCiD</em> or <em>register a new account</em> respectively.
