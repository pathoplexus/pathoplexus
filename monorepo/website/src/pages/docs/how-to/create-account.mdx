...
To begin creating a new account, click 'Login' in the top-right on the website. You will be taken to the authentication page with the options at the bottom to <em>login with ORCiD</em> or <em>register a new account</em> respectively.

<InfoBox>
    Each username and email address can only be used once. Usernames or email addresses from disabled accounts cannot be reused.
</InfoBox>

To register using ORCiD:
1. Click 'ORCiD' in the 'sign in with:' section at the bottom of the page, then login to ORCiD, and authorize access to your account
