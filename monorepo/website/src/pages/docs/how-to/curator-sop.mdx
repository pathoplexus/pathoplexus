...
![Revise Button.](../../../images/CurationReviseButton.png){className="image-outline"}
...
![Revision Form.](../../../images/CurationRevisionForm.png){className="image-outline"}

![Version Comment.](../../../images/CurationVersionComment.png){className="image-outline"}
