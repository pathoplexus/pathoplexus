...
**Important:** When preparing metadata for bulk revisions, the `accession` column should contain accessions **without** version numbers (e.g., `PPX_0049AAG` not `PPX_0049AAG.1`).
