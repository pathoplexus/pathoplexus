...
**Important:** When preparing metadata for bulk revisions, the `accession` column should contain accessions **without** version numbers (e.g., `PPD_0049AAG` not `PPD_0049AAG.1`).
