...
After [uploading sequences](/docs/how-to/upload-sequences) and before [approving them](/docs/how-to/approve-submissions) you may see something you'd like to edit, or fix a warning. You can do this by editing the sequence before releasing it.
