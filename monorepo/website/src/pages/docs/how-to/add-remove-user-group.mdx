...
Users cannot add themselves to groups; they must ask someone within a group to add them. (Users are automatically members of groups they create)

When making this request, please be sure to supply your username exactly as it appears within your user account, as this is what they will use to add you.

You can then ask them to follow the below steps to add you to their group.

## Adding a user to a group you are a member of
