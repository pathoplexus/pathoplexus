...
After [uploading sequences](/docs/how-to/upload_sequences) and while [approving them](/docs/how-to/approve_submissions) you may see something you'd like to edit, or fix a warning. You can do this by editing the sequence before releasing it.
...
You can then proceed to [approving all valid sequences](/docs/how-to/approve_submissions).
