...
| LIBRARY_SOURCE         | sequencingLibrarySource, default=OTHER                |
| LIBRARY_SELECTION      | sequencingLibrarySelection, default=unspecified       |
| LIBRARY_STRATEGY       | sequencingLibrarySelection, default=OTHER             |
