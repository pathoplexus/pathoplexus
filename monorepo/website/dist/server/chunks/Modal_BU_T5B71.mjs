...
import { a as _extends, c as createTheme, T as THEME_ID, b as useTheme, _ as _objectWithoutPropertiesLoose, u as useThemeProps, s as styled } from './useTheme_CIvg4FAM.mjs';
import PropTypes from 'prop-types';
import clsx from 'clsx';
import { unstable_useForkRef, unstable_ownerDocument, elementAcceptingRef, exactProp, unstable_useEnhancedEffect, unstable_setRef, HTMLElementType, unstable_getScrollbarSize, unstable_ownerWindow, unstable_useEventCallback, unstable_createChainedFunction, unstable_generateUtilityClasses, unstable_ClassNameGenerator, unstable_generateUtilityClass, unstable_composeClasses } from '@mui/utils';
...
function useModal(parameters) {
  ...
  const handleRef = unstable_useForkRef(modalRef, rootRef);
  ...
  const getTransitionProps = () => {
    ...
    return {
      onEnter: unstable_createChainedFunction(handleEnter, children == null ? void 0 : children.props.onEnter),
      onExited: unstable_createChainedFunction(handleExited, children == null ? void 0 : children.props.onExited)
    };
  };
  return {
    getRootProps,
...
const mdiTriangle = (props, ref) => /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", width: "1.2em", height: "1.2em", ref, ...props, children: /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M1 21h22L12 2" }) });
const ForwardRef$1 = forwardRef(mdiTriangle);

const mdiTriangleDown = (props, ref) => /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", width: "1.2em", height: "1.2em", ref, ...props, children: /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M1 3h22L12 22" }) });
const ForwardRef = forwardRef(mdiTriangleDown);

const boxClasses = unstable_generateUtilityClasses('MuiBox', ['root']);
...
const useUtilityClasses = ownerState => {
  ...
  return unstable_composeClasses(slots, getModalUtilityClass, classes);
};
...
const BasicModal = ({ isModalVisible, setModalVisible, ...props }) => {
  ...
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
    Modal,
    {
      ...
      children: /* @__PURE__ */ jsx(Box, { sx: style, children: props.children })
    }
  ) });
};

export { BasicModal as B, ForwardRef as F, ForwardRef$1 as a };
