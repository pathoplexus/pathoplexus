...
const $$Revise = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "SubmissionPageWrapper", $$SubmissionPageWrapper, { "title": "Revise sequences", "groupsResult": groupsResult }, { "default": async ($$result2) => renderTemplate`${groupsResult.match(
    ({ currentGroup: group }) => renderTemplate`${renderComponent($$result2, "RevisionForm", RevisionForm, { "accessToken": getAccessToken(Astro2.locals.session), "organism": organism, "referenceGenomeSequenceNames": referenceGenomeSequenceNames, "metadataTemplateFields": groupedInputFields, "clientConfig": clientConfig, "group": group, "submissionDataTypes": schema.submissionDataTypes, "dataUseTermsEnabled": dataUseTermsAreEnabled(), "client:load": true, "client:component-hydration": "load", "client:component-path": "/home/runner/work/pathoplexus/pathoplexus/monorepo/website/src/components/Submission/RevisionForm", "client:component-export": "RevisionForm" })}`,
    () => void 0
  )}` })}`;
}, "/home/runner/work/pathoplexus/pathoplexus/monorepo/website/src/pages/[organism]/submission/[groupId]/revise.astro", void 0);

const $$file = "/home/runner/work/pathoplexus/pathoplexus/monorepo/website/src/pages/[organism]/submission/[groupId]/revise.astro";
const $$url = "/[organism]/submission/[groupId]/revise";
